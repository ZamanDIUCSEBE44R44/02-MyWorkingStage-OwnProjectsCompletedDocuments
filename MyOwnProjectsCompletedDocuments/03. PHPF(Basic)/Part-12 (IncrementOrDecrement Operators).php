...
<body>
	<div class="phpcoding">
		...
		<?php
			...
			echo "<br />";
			echo $x++;//post Increment Operators
			echo "<br />";
			echo $x;
			echo "<br />";
			echo --$x;//pre Decrement Operators
			echo "<br />";
			echo $x--;//post Decrement Operators
			echo "<br />";
			echo $x;
			
		?>
		<br /><a href="Part-13 (Logical and Operators).php">Part-13 (Logical and Operators)</a>
		</section>
