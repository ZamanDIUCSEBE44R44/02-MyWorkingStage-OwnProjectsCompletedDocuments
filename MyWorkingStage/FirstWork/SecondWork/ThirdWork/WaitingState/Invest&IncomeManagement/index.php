		...
		<div class="phpcoding">
			...
			<hr />
					...
					<form action="" method="post">
						<p>Investing Date:(তারিখ)  <input type="date" name="investing_date" id="" /></p>
						<p>Fittings:(জিনিসপত্র) <input type="text" name="fittings" id="" /></p>
						<p>Amount Of Money: (টাকার পরিমান) <input type="text" name="amount_of_money" id="" /></p> 
